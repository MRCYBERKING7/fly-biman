...
logo = "'\n\x1b[1;91m' ##:::'##:'##::::'##::::'###::::'##::: ##:\n'\x1b[1;92m'##::'##:: ##:::: ##:::'## ##::: ###:: ##:\n'\x1b[1;91m'##:'##::: ##:::: ##::'##:. ##:: ####: ##:\n'\x1b[1;97m'#####:::: #########:'##:::. ##: ## ## ##:\n'\x1b[1;93m'##. ##::: ##.... ##: #########: ##. ####:\n'\x1b[1;94m'##:. ##:: ##:::: ##: ##.... ##: ##:. ###:\n'\x1b[1;92m'##::. ##: ##:::: ##: ##:::: ##: ##::. ##:\n'\x1b[1;91m'..::::..::..:::::..::..:::::..::..::::..::\n\t\n'\x1b[1;92m'   Author      :     MR.ERORR     \n'\x1b[1;91m'   Github      :     MRCYBERKING7  \n'\x1b[1;96m'   FB ID       :     MR.RAFI\n'\x1b[1;93m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;91m'   WAP NUMBER  :     01401607898            \n"
dec = '2'
server = '2'
...
def main_apv():
    ...
    try:
        ...
        os.system('xdg-open https://wa.me/+8801401607898')

    r1 = requests.get('https://pastebin.com/raw/yEfxiRxM').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        ...
        print '             Agar Ap Na Subscription Kar Le Ha To'
        raw_input('  Termux Sa Exit Kar Ka Phir Sa Cammonds Lagio Thanks')
        os.system('xdg-open https://wa.me/+8801410607898')
